...
function reset() {
  ...
  total.textContent = "";
  buttonA.style.display = "initial";
  buttonB.style.display = "initial";
  buttonC.style.display = "initial";
}
...
function pago(e) {
  ...
  if (cantidad2.value == total2.value) {
    final.innerHTML = `<p class="text-center encabezado">Disfrute la película ${pelicula.nombre}🎥</p><br><h1 class="text-center">Estas son películas populares del momento, en un futuro podrás verlas en cartelera.</h1>`;
    cartel.style.display = "none";
    compra.style.display = "none";
    compra2.style.display = "none";
    cargarPeliculas();
    ...
    }, disfrute la película ${pelicula.nombre}🎥</p><br><h1 class="text-center">Estas son películas populares del momento, en un futuro podrás verlas en cartelera.</h1>`;
    cartel.style.display = "none";
    compra.style.display = "none";
    compra2.style.display = "none";
    cargarPeliculas();
